  ...
  for (const batch of batches) {
    const batchPromises = batch.map(async (email) => {
      try {
        ...
        return {
          email,
          result: detailed ? createErrorDetailedResult(email) : { validFormat: false, validMx: null, validSmtp: null, detectedName: null, domainSuggestion: null }
        };
      }
    });
